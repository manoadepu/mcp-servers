 ...
 * Provider events
 */
export type ProviderEventType = 'repository.update' | 'repository.delete' | 'commit.new' | 'commit.analyze' | 'analysis.start' | 'analysis.complete' | 'analysis.error' | 'provider.connect' | 'provider.disconnect' | 'provider.error' | 'provider.ratelimit';
 ...
 * Provider errors
 */
export type ProviderErrorCode = 'AUTH_FAILED' | 'PERMISSION_DENIED' | 'RESOURCE_NOT_FOUND' | 'RATE_LIMIT_EXCEEDED' | 'NETWORK_ERROR' | 'INVALID_REQUEST' | 'OPERATION_FAILED';
