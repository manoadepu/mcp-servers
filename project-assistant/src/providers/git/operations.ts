...
import { GitErrorCode, GitErrorDetails, GitProviderError, GitPRInfo } from './types';
...
export class GitOperations {
   ...
   */
  public async getPRInfo(prNumber: string): Promise<GitPRInfo> {
    try {
      await this.verifyRepository();
   ...
   */
  public async getPRChanges(prNumber: string, excludePaths: string[] = ['node_modules']): Promise<{
    files: Array<{
      file: string;
      changes: number;
      insertions: number;
